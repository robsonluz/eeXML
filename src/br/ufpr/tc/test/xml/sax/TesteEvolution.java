...
public class TesteEvolution extends DefaultHandler
{
    ...
    public static void main(String argv[])
    {
        ...
        TesteEvolution handler = new TesteEvolution();
        ...
        try{
	        ...
	        Evolution e = new Evolution(handler.lstData,ta);
	        ta = e.evolution();
	        
	        System.out.println(e.tirarParentese("((abc))"));
	        System.out.println("\n\n----------------------");
	        ta.printTreeAutomata();
	        //System.out.println("\n\nResultado: "+v.validar());
        }catch(Exception e){
