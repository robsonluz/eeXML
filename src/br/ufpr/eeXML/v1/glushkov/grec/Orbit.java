...
public class Orbit implements Cloneable
{
	...
	private boolean isSaida(Regex n,List<Transition> lst)
	{
		for(Transition t:lst)
		{
	...
	private boolean isEntrada(Regex n,List<Transition> lst)
	{
		for(Transition t:lst)
		{
	...
	public void setEstadoAtualBackEdge(Regex x)
	{
		if(backEdge!=null)
	...
	public void setEstadoNovoBackEdge(Regex x)
	{
		if(backEdge!=null)
