...
public class OrRegex extends Regex
{
	...
	public OrRegex(String value1, Regex value2) 
	{
		this(new SingleRegex(value1),value2);
	}
	public OrRegex(Regex value1, String value2) 
	{
		this(value1,new SingleRegex(value2));
	}
	public OrRegex(String value1, String value2) 
	{
	...
	public Regex clone()
	{
		return new OrRegex(value1.clone(),value2.clone());
	}
	...
	{
		if(getParent()!=null && getParent() instanceof OrRegex)
