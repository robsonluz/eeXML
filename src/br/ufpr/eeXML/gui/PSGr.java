...
public class PSGr extends java.awt.Graphics2D
{
	final public static int CLONE = 49;
	final protected static int PAGEHEIGHT = 792;
	final protected static int PAGEWIDTH = 612;
	final protected static int XOFFSET = 30;
	final protected static int YOFFSET = 30;
	/**
	 hexadecimal digits
	 */
	...
	final protected static int charsPerRow = 12*6;
	/**
	...
	public void clipRect(int x, int y, int width, int height) {
		...
		//*** modified by Joachim Bergmeyer <jbergmeyer@owl-online.de>
