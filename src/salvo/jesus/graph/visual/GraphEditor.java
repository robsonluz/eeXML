...
public class GraphEditor extends JPanel {
	...
	public GraphEditor(boolean visibleToolBar) {
		this.graphscrollpane = new GraphScrollPane(new GraphPanelNormalState());
	...
	private void doGraphEditorLayout() {
		...
		this.splitpane.setOneTouchExpandable(visibleToolBar);
